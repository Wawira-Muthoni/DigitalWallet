...
from .view import edit_customer,customer_profile,list_currencys,list_cards,list_loans ,list_wallets,list_rewards, list_thirdpartys, list_transactions,list_receipts,list_accounts, list_customers, list_wallets, register_Account,list_notifications, register_Currency, register_Receipt, register_Transaction, register_customer,register_Account,register_wallet,register_Card,register_ThirdParty,register_Loan,register_Reward,register_Notification
